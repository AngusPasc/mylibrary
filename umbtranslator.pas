...
constructor TMBTranslator.Create(Name : String; Surname : String; const SQLQuery :  TSQLQuery; const SQLTransaction : TSQLTransaction);
begin
     //ДК, проверяем если добавлен новый переводчик
     SQLQuery.Close;
     SQLQuery.SQL.Text:='SELECT id FROM translators where surname=:bSurname';
